Public Class Disinstallazione_Software_Installati
    ...
    Private Sub Disinstallazione_Software_Installati_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Label8_Click(sender As Object, e As EventArgs) Handles Label8.Click
        ...
        Software_Package_Installer.Panel2.Hide()
        Software_Package_Installer.Panel3.Show()
        Software_Package_Installer.Panel1.Hide()
    End Sub

    Private Sub Label5_Click(sender As Object, e As EventArgs) Handles Label5.Click
        Software_Package_Installer_ME.Show()
        Software_Package_Installer_ME.Panel3.Show()
        Software_Package_Installer_ME.Panel1.Hide()
        Software_Package_Installer_ME.Panel2.Hide()
    End Sub

    Private Sub Label7_Click(sender As Object, e As EventArgs) Handles Label7.Click
        Soft_Usb_Passwords.Show()
        Soft_Usb_Passwords.Panel2.Hide()
        Soft_Usb_Passwords.Panel3.Show()
        Soft_Usb_Passwords.Panel1.Hide()
    End Sub

    Private Sub Label10_Click(sender As Object, e As EventArgs) Handles Label10.Click
        Soft_Optimizer.Show()
        Soft_Optimizer.Panel2.Hide()
        Soft_Optimizer.Panel3.Show()
